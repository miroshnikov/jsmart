...
*/
(function(){function J(a,c){for(var b=1;b<arguments.length;++b)for(var d in arguments[b])a[d]=arguments[b][d];return a}function K(a){var c=0,b;for(b in a)a.hasOwnProperty(b)&&c++;return c}function G(a,c){if(Array.prototype.indexOf)return a.indexOf(c);for(var b=0;b<a.length;++b)if(a[b]===c)return b;return-1}function P(a){return a.replace(/\\t/,"\t").replace(/\\n/,"\n").replace(/\\(['"\\])/g,"$1")}function E(a){return P(a.replace(/^['"](.*)['"]$/,"$1")).replace(/^\s+|\s+$/g,"")}function B(a,c){for(var b=
...
Array&&(e=d.length);"undefined"!=typeof b&&f==a.parts.length-1&&(d[e]=b);if(!("object"==typeof d&&null!==d&&e in d)){if("undefined"==typeof b)return b;d[e]={}}d=d[e]}}return d}function p(a,c){for(var b="",d=0;d<a.length;++d){var e="",f=a[d];if("text"==f.type)e=f.data;else if("var"==f.type)e=C(f,c);else if("build-in"==f.type)e=F[f.name].process(f,c);else if("plugin"==f.type){var g=A[f.name];if("block"==g.type){var l={value:!0};for(g.process(y(f.params,c),"",c,l);l.value;)l.value=!1,e+=g.process(y(f.params,
c),p(f.subTree,c),c,l)}else"function"==g.type&&(e=g.process(y(f.params,c),c))}"boolean"==typeof e&&(e=e?"1":"");if(1==a.length)return e;b+=null!==e?e:"";if(c.smarty["continue"]||c.smarty["break"])break}return b}function aa(a,c,b){if(!b&&a in V)c=V[a];else{b=jSmart.prototype.getTemplate(a);if("string"!=typeof b)throw Error("No template for "+a);r(N(jSmart.prototype.filters_global.pre,ba(b.replace(/\r\n/g,"\n"))),c);V[a]=c}return c}function ba(a){for(var c="",b=RegExp(jSmart.prototype.left_delimiter+
"\\*"),d=RegExp("\\*"+jSmart.prototype.right_delimiter),e=a.match(b);e;e=a.match(b)){c+=a.slice(0,e.index);a=a.slice(e.index+e[0].length);e=a.match(d);if(!e)throw Error("Unclosed "+jSmart.left_delimiter+"*");a=a.slice(e.index+e[0].length)}return c+a}function N(a,c){for(var b=0;b<a.length;++b)c=a[b](c);return c}var F={expression:{parse:function(a,c){var b=I(a);c.push({type:"build-in",name:"expression",expression:b.tree,params:z(a.slice(b.value.length).replace(/^\s+|\s+$/g,""))});return b.tree},process:function(a,
c){var b=y(a.params,c),d=p([a.expression],c);if(0>G(b,"nofilter")){for(b=0;b<default_modifiers.length;++b){var e=default_modifiers[b];e.params.__parsed[0]={type:"text",data:d};d=p([e],c)}escape_html&&(d=H.__escape(d));d=N(varFilters,d);O.length&&(__t=function(){return d},d=p(O,c))}return d}},operator:{process:function(a,c){var b=y(a.params,c),d=b[0];if("binary"==a.optype){b=b[1];if("="==a.op)return C(a.params.__parsed[0],c,b),"";if(a.op.match(/(\+=|-=|\*=|\/=|%=)/)){d=C(a.params.__parsed[0],c);switch(a.op){case "+=":d+=
...
parse:function(a,c,b){var d=[],e=[];c.push({type:"build-in",name:"section",params:a,subTree:d,subTreeElse:e});(a=L("section [^}]+","/section","sectionelse",b))?(r(b.slice(0,a.index),d),r(b.slice(a.index+a[0].length).replace(/^[\r\n]/,""),e)):r(b,d)},process:function(a,c){var b=y(a.params,c),d={};c.smarty.section[b.__get("name",null,0)]=d;var e=b.__get("show",!0);d.show=e;if(!e)return p(a.subTreeElse,c);var e=parseInt(b.__get("start",0)),f=b.loop instanceof Object?K(b.loop):isNaN(b.loop)?0:parseInt(b.loop),
g=parseInt(b.__get("step",1)),b=parseInt(b.__get("max"));isNaN(b)&&(b=Number.MAX_VALUE);0>e?(e+=f,0>e&&(e=0)):e>=f&&(e=f?f-1:0);for(var l=0,k=e;0<=k&&k<f&&l<b;k+=g,++l);d.total=l;d.loop=l;for(var l=0,h="",k=e;0<=k&&k<f&&l<b&&!c.smarty["break"];k+=g,++l)d.first=k==e,d.last=0>k+g||k+g>=f,d.index=k,d.index_prev=k-g,d.index_next=k+g,d.iteration=d.rownum=l+1,h+=p(a.subTree,c),c.smarty["continue"]=!1;c.smarty["break"]=!1;return l?h:p(a.subTreeElse,c)}},setfilter:{type:"block",parseParams:function(a){return[I("__t()|"+
...
name:"for",params:a,subTree:d,subTreeElse:e});(a=L("for\\s[^}]+","/for","forelse",b))?(r(b.slice(0,a.index),d),r(b.slice(a.index+a[0].length),e)):r(b,d)},process:function(a,c){var b=y(a.params,c),d=parseInt(b.__get("from")),e=parseInt(b.__get("to")),f=parseInt(b.__get("step"));isNaN(f)&&(f=1);var g=parseInt(b.__get("max"));isNaN(g)&&(g=Number.MAX_VALUE);for(var l=0,k="",d=Math.min(Math.ceil(((0<f?e-d:d-e)+1)/Math.abs(f)),g),e=parseInt(b.from);l<d&&!c.smarty["break"];e+=f,++l)c[b.varName]=e,k+=p(a.subTree,
c),c.smarty["continue"]=!1;c.smarty["break"]=!1;l||(k=p(a.subTreeElse,c));return k}},"if":{type:"block",parse:function(a,c,b){var d=[],e=[];c.push({type:"build-in",name:"if",params:a,subTreeIf:d,subTreeElse:e});(a=L("if\\s+[^}]+","/if","else[^}]*",b))?(r(b.slice(0,a.index),d),b=b.slice(a.index+a[0].length),(d=a[1].match(/^else\s*if(.*)/))?F["if"].parse(z(d[1]),e,b.replace(/^\n/,"")):r(b.replace(/^\n/,""),e)):r(b,d)},process:function(a,c){var b=y(a.params,c)[0];return!b||b instanceof Array&&!b.length||
b instanceof Object&&!K(b)?p(a.subTreeElse,c):p(a.subTreeIf,c)}},foreach:{type:"block",parseParams:function(a){var c=a.match(/^\s*([$].+)\s*as\s*[$](\w+)\s*(=>\s*[$](\w+))?\s*$/i);c&&(a="from="+c[1]+" item="+(c[4]||c[2]),c[4]&&(a+=" key="+c[2]));return z(a)},parse:function(a,c,b){var d=[],e=[];c.push({type:"build-in",name:"foreach",params:a,subTree:d,subTreeElse:e});(a=L("foreach\\s[^}]+","/foreach","foreachelse",b))?(r(b.slice(0,a.index),d),r(b.slice(a.index+a[0].length).replace(/^[\r\n]/,""),e)):
r(b,d)},process:function(a,c){var b=y(a.params,c),d=b.from;"undefined"==typeof d&&(d=[]);"object"!=typeof d&&(d=[d]);var e=K(d);c[b.item+"__total"]=e;"name"in b&&(c.smarty.foreach[b.name]={},c.smarty.foreach[b.name].total=e);var f="",g=0,l;for(l in d)if(d.hasOwnProperty(l)){if(c.smarty["break"])break;c[b.item+"__key"]=isNaN(l)?l:parseInt(l);"key"in b&&(c[b.key]=c[b.item+"__key"]);c[b.item]=d[l];c[b.item+"__index"]=parseInt(g);c[b.item+"__iteration"]=parseInt(g+1);c[b.item+"__first"]=0===g;c[b.item+
"__last"]=g==e-1;"name"in b&&(c.smarty.foreach[b.name].index=parseInt(g),c.smarty.foreach[b.name].iteration=parseInt(g+1),c.smarty.foreach[b.name].first=0===g?1:"",c.smarty.foreach[b.name].last=g==e-1?1:"");++g;f+=p(a.subTree,c);c.smarty["continue"]=!1}c.smarty["break"]=!1;c[b.item+"__show"]=0<g;b.name&&(c.smarty.foreach[b.name].show=0<g?1:"");return 0<g?f:p(a.subTreeElse,c)}},"function":{type:"block",parse:function(a,c,b){c=[];A[E(a.name?a.name:a[0])]={type:"function",subTree:c,defautParams:a,process:function(a,
b){var c=y(this.defautParams,b);delete c.name;return p(this.subTree,J({},b,c,a))}};r(b,c)}},php:{type:"block",parse:function(a,c,b){}},"extends":{type:"function",parse:function(a,c){c.splice(0,c.length);aa(E(a.file?a.file:a[0]),c)}},block:{type:"block",parse:function(a,c,b){c.push({type:"build-in",name:"block",params:a});a.append=0<=G(a,"append");a.prepend=0<=G(a,"prepend");a.hide=0<=G(a,"hide");a.hasChild=a.hasParent=!1;U=function(b){b.match(/^\s*[$]smarty.block.child\s*$/)&&(a.hasChild=!0);b.match(/^\s*[$]smarty.block.parent\s*$/)&&
(a.hasParent=!0)};c=r(b,[]);U=function(a){};b=E(a.name?a.name:a[0]);b in D||(D[b]=[]);D[b].push({tree:c,params:a})},process:function(a,c){c.smarty.block.parent=c.smarty.block.child="";var b=E(a.params.name?a.params.name:a.params[0]);this.processBlocks(D[b],D[b].length-1,c);return c.smarty.block.child},processBlocks:function(a,c,b){if(!c&&a[c].params.hide)b.smarty.block.child="";else for(var d=!0,e=!1;0<=c;--c){if(a[c].params.hasParent){var f=b.smarty.block.child;b.smarty.block.child="";this.processBlocks(a,
c-1,b);b.smarty.block.parent=b.smarty.block.child;b.smarty.block.child=f}var f=b.smarty.block.child,g=p(a[c].tree,b);b.smarty.block.child=f;a[c].params.hasChild?b.smarty.block.child=g:d?b.smarty.block.child=g+b.smarty.block.child:e&&(b.smarty.block.child+=g);d=a[c].params.append;e=a[c].params.prepend}}},strip:{type:"block",parse:function(a,c,b){r(b.replace(/[ \t]*[\r\n]+[ \t]*/g,""),c)}},literal:{type:"block",parse:function(a,c,b){w(b,c)}},ldelim:{type:"function",parse:function(a,c){w(jSmart.prototype.left_delimiter,
c)}},rdelim:{type:"function",parse:function(a,c){w(jSmart.prototype.right_delimiter,c)}},"while":{type:"block",parse:function(a,c,b){c.push({type:"build-in",name:"while",params:a,subTree:r(b,[])})},process:function(a,c){for(var b="";y(a.params,c)[0]&&!c.smarty["break"];)b+=p(a.subTree,c),c.smarty["continue"]=!1;c.smarty["break"]=!1;return b}}},A={},H={},V={},D=null,W=null,O=[],M=[{re:/^\$([\w@]+)/,parse:function(a,c){u(S(c,a,RegExp.$1),a)}},{re:/^(true|false)/i,parse:function(a,c){w(a.token.match(/true/i)?
"1":"",a.tree)}},{re:/^'([^'\\]*(?:\\.[^'\\]*)*)'/,parse:function(a,c){w(P(RegExp.$1),a.tree);u(c,a)}},{re:/^"([^"\\]*(?:\\.[^"\\]*)*)"/,parse:function(a,c){var b=P(RegExp.$1),d=b.match(M[0].re);if(d){var e={token:d[0],tree:[]};S(b,e,d[1]);if(e.token.length==b.length){a.tree.push(e.tree[0]);return}}w.parseEmbeddedVars=!0;a.tree.push({type:"plugin",name:"__quoted",params:{__parsed:r(b,[])}});w.parseEmbeddedVars=!1;u(c,a)}},{re:/^(\w+)\s*[(]([)]?)/,parse:function(a,c){var b=RegExp.$1,d=z(RegExp.$2?
"":c,/^\s*,\s*/);Y(b,d,a.tree);a.value+=d.toString();u(c.slice(d.toString().length),a)}},{re:/^\s*\(\s*/,parse:function(a,c){var b=[];a.tree.push(b);b.parent=a.tree;a.tree=b}},{re:/^\s*\)\s*/,parse:function(a,c){a.tree.parent&&(a.tree=a.tree.parent)}},{re:/^\s*(\+\+|--)\s*/,parse:function(a,c){a.tree.length&&"var"==a.tree[a.tree.length-1].type?t(RegExp.$1,"post-unary",1,a.tree):t(RegExp.$1,"pre-unary",1,a.tree)}},{re:/^\s*(===|!==|==|!=)\s*/,parse:function(a,c){t(RegExp.$1,"binary",6,a.tree)}},{re:/^\s+(eq|ne|neq)\s+/i,
...
7,a.tree)}},{re:/^\s+is\s+(not\s+)?(even|odd)(\s+by\s+)?\s*/i,parse:function(a,c){t(RegExp.$1?"odd"==RegExp.$2?"even":"even_not":"odd"==RegExp.$2?"even_not":"even","binary",7,a.tree);RegExp.$3||w("1",a.tree)}},{re:/^\s*(&&)\s*/,parse:function(a,c){t(RegExp.$1,"binary",8,a.tree)}},{re:/^\s*(\|\|)\s*/,parse:function(a,c){t(RegExp.$1,"binary",9,a.tree)}},{re:/^\s+and\s+/i,parse:function(a,c){t("&&","binary",11,a.tree)}},{re:/^\s+xor\s+/i,parse:function(a,c){t("xor","binary",12,a.tree)}},{re:/^\s+or\s+/i,
parse:function(a,c){t("||","binary",13,a.tree)}},{re:/^#(\w+)#/,parse:function(a,c){var b={token:"$smarty",tree:[]};S(".config."+RegExp.$1,b,"smarty");a.tree.push(b.tree[0]);u(c,a)}},{re:/^\s*\[\s*/,parse:function(a,c){var b=z(c,/^\s*,\s*/,/^('[^'\\]*(?:\\.[^'\\]*)*'|"[^"\\]*(?:\\.[^"\\]*)*"|\w+)\s*=>\s*/);a.tree.push({type:"plugin",name:"__array",params:b});a.value+=b.toString();if(b=c.slice(b.toString().length).match(/\s*\]/))a.value+=b[0]}},{re:/^[\d.]+/,parse:function(a,c){w(a.token,a.tree);u(c,
a)}},{re:/^\w+/,parse:function(a,c){w(a.token,a.tree);u(c,a)}}];jSmart=function(a){this.tree=[];this.tree.blocks={};this.scripts={};this.default_modifiers=[];this.filters={variable:[],post:[]};this.smarty={smarty:{block:{},"break":!1,capture:{},"continue":!1,counter:{},cycle:{},foreach:{},section:{},now:Math.floor((new Date).getTime()/1E3),"const":{},config:{},current_dir:"/",template:"",ldelim:jSmart.prototype.left_delimiter,rdelim:jSmart.prototype.right_delimiter,version:"2.9"}};D=this.tree.blocks;
r(N(jSmart.prototype.filters_global.pre,ba((new String(a?a:"")).replace(/\r\n/g,"\n"))),this.tree)};jSmart.prototype.fetch=function(a){D=this.tree.blocks;W=this.scripts;escape_html=this.escape_html;default_modifiers=jSmart.prototype.default_modifiers_global.concat(this.default_modifiers);this.data=J("object"==typeof a?a:{},this.smarty);varFilters=jSmart.prototype.filters_global.variable.concat(this.filters.variable);a=p(this.tree,this.data);jSmart.prototype.debugging&&A.debug.process([],this.data);
return N(jSmart.prototype.filters_global.post.concat(this.filters.post),a)};jSmart.prototype.escape_html=!1;jSmart.prototype.registerPlugin=function(a,c,b){"modifier"==a?H["__"+c]=b:A[c]={type:a,process:b}};jSmart.prototype.registerFilter=function(a,c){(this.tree?this.filters:jSmart.prototype.filters_global)["output"==a?"post":a].push(c)};jSmart.prototype.filters_global={pre:[],variable:[],post:[]};jSmart.prototype.configLoad=function(a,c,b){b=b?b:this.data;a=a.replace(/\r\n/g,"\n").replace(/^\s+|\s+$/g,
"");for(var d=/^\s*(?:\[([^\]]+)\]|(?:(\w+)[ \t]*=[ \t]*("""|'[^'\\\n]*(?:\\.[^'\\\n]*)*'|"[^"\\\n]*(?:\\.[^"\\\n]*)*"|[^\n]*)))/m,e="",f=a.match(d);f;f=a.match(d)){a=a.slice(f.index+f[0].length);if(f[1])e=f[1];else if((!e||e==c)&&"."!=e.substr(0,1))if('"""'==f[3]){var g=a.match(/"""/);g&&(b.smarty.config[f[2]]=a.slice(0,g.index),a=a.slice(g.index+g[0].length))}else b.smarty.config[f[2]]=E(f[3]);if(f=a.match(/\n+/))a=a.slice(f.index+f[0].length);else break}};jSmart.prototype.clearConfig=function(a){a?
delete this.data.smarty.config[a]:this.data.smarty.config={}};jSmart.prototype.addDefaultModifier=function(a){a instanceof Array||(a=[a]);for(var c=0;c<a.length;++c){var b={value:"",tree:[0]};u("|"+a[c],b);(this.tree?this.default_modifiers:this.default_modifiers_global).push(b.tree[0])}};jSmart.prototype.default_modifiers_global=[];jSmart.prototype.getTemplate=function(a){throw Error("No template for "+a);};jSmart.prototype.getFile=function(a){throw Error("No file for "+a);};jSmart.prototype.getJavascript=
function(a){throw Error("No Javascript for "+a);};jSmart.prototype.getConfig=function(a){throw Error("No config for "+a);};jSmart.prototype.auto_literal=!0;jSmart.prototype.left_delimiter="{";jSmart.prototype.right_delimiter="}";jSmart.prototype.debugging=!1;jSmart.prototype.registerPlugin("function","__array",function(a,c){var b=[],d;for(d in a)a.hasOwnProperty(d)&&a[d]&&"function"!=typeof a[d]&&(b[d]=a[d]);return b});jSmart.prototype.registerPlugin("function","__func",function(a,c){for(var b=[],
d={},e=0;e<a.length;++e)b.push(a.name+"__p"+e),d[a.name+"__p"+e]=a[e];return R(("__owner"in c&&a.name in c.__owner?"__owner."+a.name:a.name)+"("+b.join(",")+")",J({},c,d))});jSmart.prototype.registerPlugin("function","__quoted",function(a,c){return a.join("")});jSmart.prototype.registerPlugin("function","break",function(a,c){c.smarty["break"]=!0;return""});jSmart.prototype.registerPlugin("function","continue",function(a,c){c.smarty["continue"]=!0;return""});jSmart.prototype.registerPlugin("function",
"call",function(a,c){var b=a.__get("name",null,0);delete a.name;var d=a.__get("assign",!1);delete a.assign;b=A[b].process(a,c);return d?(x(d,b,c),""):b});jSmart.prototype.registerPlugin("function","append",function(a,c){var b=a.__get("var",null,0);b in c&&c[b]instanceof Array||(c[b]=[]);var d=a.__get("index",!1),e=a.__get("value",null,1);!1===d?c[b].push(e):c[b][d]=e;return""});jSmart.prototype.registerPlugin("function","assign",function(a,c){x(a.__get("var",null,0),a.__get("value",null,1),c);return""});
jSmart.prototype.registerPlugin("block","capture",function(a,c,b,d){c&&(c=c.replace(/^\n/,""),b.smarty.capture[a.__get("name","default",0)]=c,"assign"in a&&x(a.assign,c,b),(a=a.__get("append",!1))&&(a in b?b[a]instanceof Array&&b[a].push(c):b[a]=[c]));return""});jSmart.prototype.registerPlugin("function","eval",function(a,c){var b=[];r(a.__get("var","",0),b);b=p(b,c);return"assign"in a?(x(a.assign,b,c),""):b});jSmart.prototype.registerPlugin("function","include",function(a,c){var b=a.__get("file",
null,0),d=J({},c,a);d.smarty.template=b;b=p(aa(b,[],0<=G(a,"nocache")),d);return"assign"in a?(x(a.assign,b,c),""):b});jSmart.prototype.registerPlugin("block","nocache",function(a,c,b,d){return c});jSmart.prototype.registerPlugin("block","javascript",function(a,c,b,d){b.$this=b;R(c,b);delete b.$this;return""});jSmart.prototype.registerPlugin("function","config_load",function(a,c){jSmart.prototype.configLoad(jSmart.prototype.getConfig(a.__get("file",null,0)),a.__get("section","",1),c);return""});jSmart.prototype.registerPlugin("modifier",
"defaultValue",function(a,c){return a&&"null"!=a&&"undefined"!=a?a:c?c:""});var m={window:"object"==typeof window?window:{document:{}}};String.prototype.fetch=function(a){return(new jSmart(this)).fetch(a)};jSmart.prototype.registerPlugin("function","counter",function(a,c){var b=a.__get("name","default");if(b in c.smarty.counter){var d=c.smarty.counter[b];"start"in a?d.value=parseInt(a.start):(d.value=parseInt(d.value),d.skip=parseInt(d.skip),d.value="down"==d.direction?d.value-d.skip:d.value+d.skip);
d.skip=a.__get("skip",d.skip);d.direction=a.__get("direction",d.direction);d.assign=a.__get("assign",d.assign)}else c.smarty.counter[b]={value:parseInt(a.__get("start",1)),skip:parseInt(a.__get("skip",1)),direction:a.__get("direction","up"),assign:a.__get("assign",!1)};return c.smarty.counter[b].assign?(c[c.smarty.counter[b].assign]=c.smarty.counter[b].value,""):a.__get("print",!0)?c.smarty.counter[b].value:""});jSmart.prototype.registerPlugin("function","cycle",function(a,c){var b=a.__get("name",
"default"),d=a.__get("reset",!1);b in c.smarty.cycle||(c.smarty.cycle[b]={arr:[""],delimiter:a.__get("delimiter",","),index:0},d=!0);a.__get("delimiter",!1)&&(c.smarty.cycle[b].delimiter=a.delimiter);var e=a.__get("values",!1);if(e){var f=[];if(e instanceof Object)for(nm in e)f.push(e[nm]);else f=e.split(c.smarty.cycle[b].delimiter);if(f.length!=c.smarty.cycle[b].arr.length||f[0]!=c.smarty.cycle[b].arr[0])c.smarty.cycle[b].arr=f,c.smarty.cycle[b].index=0,d=!0}a.__get("advance","true")&&(c.smarty.cycle[b].index+=
1);if(c.smarty.cycle[b].index>=c.smarty.cycle[b].arr.length||d)c.smarty.cycle[b].index=0;return a.__get("assign",!1)?(x(a.assign,c.smarty.cycle[b].arr[c.smarty.cycle[b].index],c),""):a.__get("print",!0)?c.smarty.cycle[b].arr[c.smarty.cycle[b].index]:""});jSmart.prototype.print_r=function(a,c){if(a instanceof Object){var b=(a instanceof Array?"Array["+a.length+"]":"Object")+"<br>",d;for(d in a)a.hasOwnProperty(d)&&(b+=c+"&nbsp;&nbsp;<strong>"+d+"</strong> : "+jSmart.prototype.print_r(a[d],c+"&nbsp;&nbsp;&nbsp;")+
"<br>");return b}return a};jSmart.prototype.registerPlugin("function","debug",function(a,c){"undefined"!=typeof dbgWnd&&dbgWnd.close();dbgWnd=window.open("","","width=680,height=600,resizable,scrollbars=yes");var b="",d=0,e;for(e in c)b+="<tr class="+(++d%2?"odd":"even")+"><td><strong>"+e+"</strong></td><td>"+jSmart.prototype.print_r(c[e],"")+"</td></tr>";dbgWnd.document.write("            <html xmlns='http://www.w3.org/1999/xhtml' xml:lang='en'>            <head> \t            <title>jSmart Debug Console</title>               <style type='text/css'>                  table {width: 100%;}                  td {vertical-align:top;width: 50%;}                  .even td {background-color: #fafafa;}               </style>            </head>            <body>               <h1>jSmart Debug Console</h1>               <h2>assigned template variables</h2>               <table>"+
